    ...
    return (
      <Layout>
        ...
        <Container>
          <Row className='my-5'>
            <Col xs={12} sm={6}>
              <h1 className='my-5'>The King - Modern Furniture</h1>
              <div>
